...
xTroid.addCMD({pattern: 'mood ?(.*)', fromMe: false}, (async (message, match) => {

    await message.client.sendMessage(message.jid, '@' + message.reply_message.jid.split('@')[0] + ' *I m Searching your moood..* ', MessageType.text, {
...
xTroid.addCMD({pattern: 'infomood', fromMe: true}, (async (message, match) => {

    

    await message.sendMessage('*Codded by @Dark Alpha*\🏟️Usage: *.mood <reply>*\n🔥Desc: Finds what your responding one‘s moods.\🔥 _Support Filters!_');
